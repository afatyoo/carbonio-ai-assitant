...
export const CARBONIO_USER_CAPABILITIES = Object.freeze([
	...
	planned('list_folders', 'mail', TOOL_RISK.READ, 'mail.read', ['GetFolder']),
	planned('create_folder', 'mail', TOOL_RISK.WRITE, 'mail.write', ['CreateFolder']),
	planned('rename_folder', 'mail', TOOL_RISK.WRITE, 'mail.write', ['GetFolder', 'FolderAction']),
	planned('move_folder', 'mail', TOOL_RISK.WRITE, 'mail.write', ['GetFolder', 'FolderAction']),
	planned('delete_folder', 'mail', TOOL_RISK.DESTRUCTIVE, 'mail.write', ['GetFolder', 'FolderAction']),
	planned('empty_trash', 'mail', TOOL_RISK.DESTRUCTIVE, 'mail.write', ['FolderAction']),
	planned('list_tags', 'mail', TOOL_RISK.READ, 'mail.read', ['GetTag']),
	planned('create_tag', 'mail', TOOL_RISK.WRITE, 'mail.write', ['CreateTag']),
	planned('rename_tag', 'mail', TOOL_RISK.WRITE, 'mail.write', ['GetTag', 'TagAction']),
	planned('delete_tag', 'mail', TOOL_RISK.DESTRUCTIVE, 'mail.write', ['GetTag', 'TagAction']),
	planned('mark_as_unread', 'mail', TOOL_RISK.WRITE, 'mail.write', ['GetMsg', 'MsgAction']),
	planned('flag_email', 'mail', TOOL_RISK.WRITE, 'mail.write', ['GetMsg', 'MsgAction']),
	planned('unflag_email', 'mail', TOOL_RISK.WRITE, 'mail.write', ['GetMsg', 'MsgAction']),
	planned('archive_email', 'mail', TOOL_RISK.WRITE, 'mail.write', ['GetMsg', 'MsgAction']),
	planned('mark_as_spam', 'mail', TOOL_RISK.WRITE, 'mail.write', ['GetMsg', 'MsgAction']),
	planned('mark_as_not_spam', 'mail', TOOL_RISK.WRITE, 'mail.write', ['GetMsg', 'MsgAction']),
	planned('restore_email', 'mail', TOOL_RISK.WRITE, 'mail.write', ['GetMsg', 'MsgAction']),
	planned('remove_tag', 'mail', TOOL_RISK.WRITE, 'mail.write', ['GetMsg', 'MsgAction']),
