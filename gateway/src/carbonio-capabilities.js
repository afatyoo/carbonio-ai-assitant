...
export const CARBONIO_USER_CAPABILITIES = Object.freeze([
	...
	active('archive_email', 'mail', TOOL_RISK.WRITE, 'mail.write', ['GetMsg', 'GetFolder', 'MsgAction']),
	active('restore_email', 'mail', TOOL_RISK.WRITE, 'mail.write', ['GetMsg', 'GetFolder', 'MsgAction']),
	active('remove_attachment', 'mail', TOOL_RISK.DESTRUCTIVE, 'mail.write', ['GetMsg', 'RemoveAttachments']),
	...
	active('list_contacts', 'contacts', TOOL_RISK.READ, 'contacts.read', ['GetContacts']),
	active('get_contact', 'contacts', TOOL_RISK.READ, 'contacts.read', ['GetContacts']),
	active('create_contact', 'contacts', TOOL_RISK.WRITE, 'contacts.write', ['CreateContact']),
	active('update_contact', 'contacts', TOOL_RISK.WRITE, 'contacts.write', ['GetContacts', 'ModifyContact']),
	active('move_contact', 'contacts', TOOL_RISK.WRITE, 'contacts.write', ['GetContacts', 'GetFolder', 'ContactAction']),
	active('tag_contact', 'contacts', TOOL_RISK.WRITE, 'contacts.write', ['GetContacts', 'ContactAction']),
	active('delete_contact', 'contacts', TOOL_RISK.DESTRUCTIVE, 'contacts.write', ['GetContacts', 'ContactAction']),

	active('list_calendars', 'calendar', TOOL_RISK.READ, 'calendar.read', ['GetFolder']),
	active('respond_to_invitation', 'calendar', TOOL_RISK.WRITE, 'calendar.write', ['GetAppointment', 'SendInviteReply']),
	active('forward_appointment', 'calendar', TOOL_RISK.WRITE, 'calendar.write', ['GetAppointment', 'ForwardAppointment']),
	active('dismiss_alarm', 'calendar', TOOL_RISK.WRITE, 'calendar.write', ['GetAppointment', 'DismissCalendarItemAlarm']),
	active('snooze_alarm', 'calendar', TOOL_RISK.WRITE, 'calendar.write', ['GetAppointment', 'SnoozeCalendarItemAlarm']),
	active('create_calendar', 'calendar', TOOL_RISK.WRITE, 'calendar.write', ['CreateFolder']),
	active('rename_calendar', 'calendar', TOOL_RISK.WRITE, 'calendar.write', ['FolderAction']),
	active('delete_calendar', 'calendar', TOOL_RISK.DESTRUCTIVE, 'calendar.write', ['DeleteCalendar']),

	active('list_shares', 'sharing', TOOL_RISK.READ, 'sharing.read', ['GetFolder']),
	active('grant_share', 'sharing', TOOL_RISK.WRITE, 'sharing.write', ['FolderAction']),
	active('revoke_share', 'sharing', TOOL_RISK.DESTRUCTIVE, 'sharing.write', ['FolderAction']),
	active('send_share_notification', 'sharing', TOOL_RISK.WRITE, 'sharing.write', ['SendShareNotification']),
	active('list_filter_rules', 'preferences', TOOL_RISK.READ, 'preferences.read', ['GetFilterRules']),
	active('create_filter_rule', 'preferences', TOOL_RISK.WRITE, 'preferences.write', ['GetFilterRules', 'ModifyFilterRules']),
	active('update_filter_rule', 'preferences', TOOL_RISK.WRITE, 'preferences.write', ['GetFilterRules', 'ModifyFilterRules']),
	active('delete_filter_rule', 'preferences', TOOL_RISK.DESTRUCTIVE, 'preferences.write', ['GetFilterRules', 'ModifyFilterRules']),
	active('list_identities', 'preferences', TOOL_RISK.READ, 'preferences.read', ['GetIdentities']),
	active('create_identity', 'preferences', TOOL_RISK.WRITE, 'preferences.write', ['CreateIdentity']),
	active('update_identity', 'preferences', TOOL_RISK.WRITE, 'preferences.write', ['GetIdentities', 'ModifyIdentity']),
	active('delete_identity', 'preferences', TOOL_RISK.DESTRUCTIVE, 'preferences.write', ['GetIdentities', 'DeleteIdentity']),
	active('list_signatures', 'preferences', TOOL_RISK.READ, 'preferences.read', ['GetSignatures']),
	active('create_signature', 'preferences', TOOL_RISK.WRITE, 'preferences.write', ['CreateSignature']),
	active('update_signature', 'preferences', TOOL_RISK.WRITE, 'preferences.write', ['GetSignatures', 'ModifySignature']),
	active('delete_signature', 'preferences', TOOL_RISK.DESTRUCTIVE, 'preferences.write', ['GetSignatures', 'DeleteSignature']),
